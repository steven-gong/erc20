...
mod erc20 {
    ...
    impl TERC20 for Erc20 {
        ...
        // #[ink(message)]
        // fn allowances_of(&self, to: AccountId) -> Balance {
        //     let caller = self.env().caller();
        //     self.allowances.get(&(caller, to)).unwrap_or_default()
        // }
    ...
    mod tests {
        ...
        fn constructor_works() {
            let erc20 = Erc20::new(10_000);
            let accounts = ink::env::test::default_accounts::<ink::env::DefaultEnvironment>();
            assert_eq!(erc20.total_supply(), 10_000);
            assert_eq!(erc20.balance_of(accounts.alice), 10_000);
        ...
        fn transfer_should_work() {
            ...
            assert!(res.is_ok());
            assert_eq!(erc20.balance_of(accounts.alice), 10_000 - 12);
